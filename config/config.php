...
return [
    ...
    'delivery' => [
        // Сколько запросов в минуту принимает поставщик. Значение попадает
        // в базу при первом запуске и дальше меняется там: лимит общий
        // для всех исполнителей.
        'rate_limit' => (int) (getenv('PROVIDER_RATE_LIMIT') ?: 60),
