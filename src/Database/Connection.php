...
interface Connection
{
    ...
    /**
     * Закрывает соединение. Следующий запрос откроет новое.
     *
     * Нужно долгоживущим процессам: после разрыва связи с базой дескриптор
     * непригоден, и без сброса все последующие запросы будут падать.
     */
